# Roadmap: infra-krakenops MVP & Beyond

## Overview
- **MVP Goal**: Launch a working prototype to validate manage KrakenOps infrastructure configurations.
- **Launch Timeline**: Q4 2025.
- **Success Metrics**: 5 infra components managed, 95% automation.
...
|----------|--------------|-------------|--------|----------------------------|--------------|
| **Must-Have (MVP Core)** | [Feature 1] | [TBD: Core feature for infra-krakenops. Why: Enables manage KrakenOps infrastructure configurations.] | Not Started | 5 | None |
...
## How to Contribute
- Propose features via [GitHub Issues](https://github.com/NesoHQ/infra-krakenops/issues/new?template=feature_request.md).
